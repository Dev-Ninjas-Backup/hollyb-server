  ...
  async getBackgroundCheckDetail(id: string) {
    ...
    if (row.role === UserRole.employee && row.employee_profile) {
      detail.profile = {
        ...
        latitude: row.employee_profile.latitude,
        longitude: row.employee_profile.longitude,
    ...
    if (row.role === UserRole.employer && row.employer_profile) {
      detail.profile = {
        ...
        latitude: row.employer_profile.latitude,
        longitude: row.employer_profile.longitude,
