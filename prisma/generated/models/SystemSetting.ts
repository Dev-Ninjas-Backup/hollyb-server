...
type GetSystemSettingGroupByPayload<T extends SystemSettingGroupByArgs> =
  Prisma.PrismaPromise<
    Array<
      Prisma.PickEnumerable<SystemSettingGroupByOutputType, T['by']> & {
        [P in keyof T &
          keyof SystemSettingGroupByOutputType]: P extends '_count'
          ? T[P] extends boolean
            ? number
...
export type SystemSettingScalarWhereWithAggregatesInput = {
  ...
  value?:
    | Prisma.StringNullableWithAggregatesFilter<'SystemSetting'>
    | string
    | null;
  description?:
    | Prisma.StringNullableWithAggregatesFilter<'SystemSetting'>
    ...
    | null;
  updated_by?:
    | Prisma.UuidNullableWithAggregatesFilter<'SystemSetting'>
    | string
    | null;
  updated_at?:
    | Prisma.DateTimeWithAggregatesFilter<'SystemSetting'>
    | Date
    | string;
};
...
export type SystemSettingCreateInput = {
  ...
  updater?: Prisma.UserCreateNestedOneWithoutUpdated_settingsInput;
};
...
export type SystemSettingUpdateInput = {
  ...
  updater?: Prisma.UserUpdateOneWithoutUpdated_settingsNestedInput;
};
...
export type SystemSettingCreateManyUpdaterInputEnvelope = {
  data:
    | Prisma.SystemSettingCreateManyUpdaterInput
    | Prisma.SystemSettingCreateManyUpdaterInput[];
...
> = {
   ...
   */
  data:
    | Prisma.SystemSettingCreateManyInput
    | Prisma.SystemSettingCreateManyInput[];
  skipDuplicates?: boolean;
};
